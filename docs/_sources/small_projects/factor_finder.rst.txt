...
A number’s factors are any two other numbers that, when multiplied with each
...
that 26 has four factors: 1, 2, 13, and 26.
...
.. collapse:: factor_finder.py

   .. literalinclude:: factor_finder.py
      :language: python
      :linenos:
