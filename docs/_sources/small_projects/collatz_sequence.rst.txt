...
The Collatz sequence, also called the 3n + 1 problem, is the simplest
...
It is generally thought, but so far not mathematically proven, that every
...
.. collapse:: collatz_sequence.py

   .. literalinclude:: collatz_sequence.py
      :language: python
      :linenos:


https://inventwithpython.com/bigbookpython/project12.html
