...
The Powerball Lottery is an exciting way to lose small amounts of money. If you
...
more you like losing money, the more fun the lottery is!
...
and 6. Those numbers are just as likely to come up as a more complex set.


.. collapse:: powerball_lottery.py

   .. literalinclude:: powerball_lottery.py
      :language: python
      :linenos:
