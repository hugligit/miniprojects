...
Watch your own virtual fish in a virtual fish tank, complete with air bubblers
...
can be found at https://pypi.org/project/bext/.


.. collapse:: fish_tank.py

   .. literalinclude:: fish_tank.py
      :language: python
      :linenos:
