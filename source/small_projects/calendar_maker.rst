...
This program generates printable text files of monthly calendars for the
...
multiline string for the monthly calendar page.

.. collapse:: calendar_maker.py

   .. literalinclude:: calendar_maker.py
      :language: python
      :linenos:
