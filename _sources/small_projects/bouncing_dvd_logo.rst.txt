...
If you are of a certain age, you’ll remember those ancient technological
...
especially for the magical moment when a logo lines up perfectly with a corner.

You can’t run this program from your integrated development environment (IDE)
...
information about the bext module at https://pypi.org/project/bext/.


.. collapse:: bouncing_dvd_logo.py

   .. literalinclude:: bouncing_dvd_logo.py
      :language: python
      :linenos:
